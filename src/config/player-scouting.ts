...
export const PLAYER_SCOUTING_2026: Record<string, PlayerScouting> = {
  ...
  // ── PFF-exclusive prospects (not ranked by CBS) ────────────────────────────
  "a.j. harris": {
    height: "6-0", weight: "185 lbs",
    strengths: "Technically refined press-man corner who consistently wins at the catch point; outstanding PFF coverage grade (90.3) in 2025 with elite ball-hawking instincts and closing burst.",
    weakness: "Limited sample against elite competition; needs to prove top-end speed at the combine against faster NFL receivers.",
    projection: "Day 2 / Rounds 2–3",
    comp: "Patrick Surtain II (technical comparables)",
  },
  "a'mauri washington": {
    height: "6-3", weight: "295 lbs",
    strengths: "Explosive interior disruptor with rare athleticism and length for a 3-technique; relentless motor and burst off the snap generate consistent interior pressure.",
    weakness: "Pad level and hand technique are still maturing; needs to develop a reliable counter move when his primary rush fails.",
    projection: "Day 2 / Early Round 3",
    comp: "Levi Onwuzurike",
  },
  "austin siereveld": {
    height: "6-5", weight: "330 lbs",
    strengths: "Powerful interior lineman with elite anchor strength; dominant in-line run blocker who controls the point of attack and wins with leverage and physicality.",
    weakness: "Lacks the lateral agility for consistent zone-scheme applications; footwork in pass protection against speed rushers needs refinement.",
    projection: "Day 2–3 / Rounds 3–4",
    comp: "Wyatt Teller (power profile)",
  },
  "charles jagusah": {
    height: "6-5", weight: "310 lbs",
    strengths: "Versatile interior lineman with top athleticism for a big man; excels in gap-blocking and shows upside as both a center and guard at the next level.",
    weakness: "Technique in pass protection can be inconsistent; a bit of a projection due to limited starts at Notre Dame.",
    projection: "Day 3 / Rounds 3–5",
    comp: "Blake Freeland (versatility profile)",
  },
  "dante moore": {
    height: "6-3", weight: "210 lbs",
    strengths: "Elite arm talent with rare velocity, touch, and ability to fit the ball into tight windows; flashes the footwork and escapability to extend plays and create off-schedule.",
    weakness: "Decision-making under pressure remains inconsistent; pad-level accuracy on rollout throws needs refinement entering the NFL.",
    projection: "Day 2 / Rounds 2–3",
    comp: "Malik Willis (upside comp)",
  },
  "ian strong": {
    height: "6-2", weight: "200 lbs",
    strengths: "Highly productive possession receiver with outstanding contested-catch ability; shows natural hands, reliable body control, and good YAC quickness for his size.",
    weakness: "Limited top-end speed makes it difficult to separate vertically; best suited as a possession/slot receiver at the next level.",
    projection: "Day 3 / Rounds 4–5",
    comp: "Van Jefferson",
  },
  "matayo uiagalelei": {
    height: "6-5", weight: "260 lbs",
    strengths: "Ideal size and length for an NFL edge rusher with an active, well-refined pass-rush plan; elite hands usage and a reliable spin move that generates clean wins.",
    weakness: "Explosiveness off the snap is below average for the position; needs to improve first-step quickness to consistently threaten NFL tackles.",
    projection: "Day 2 / Round 3",
    comp: "Rashan Gary (developmental profile)",
  },
  "quincy rhodes": {
    height: "6-3", weight: "255 lbs",
    strengths: "High-motor edge defender with elite get-off quickness and relentless pursuit; outstanding pass-rush production (12 sacks in 2025) powered by a lightning-fast spin move.",
    weakness: "Run defense is a significant developmental area; lacks the mass and anchor to routinely set the edge against NFL-caliber power blockers.",
    projection: "Day 2–3 / Rounds 3–4",
    comp: "Khalil Mack (rush style, not ceiling)",
  },
  "rod moore": {
    height: "5-11", weight: "195 lbs",
    strengths: "Elite instincts and playmaking ability in zone coverage; outstanding football IQ allows him to anticipate routes and break on the ball at an elite level.",
    weakness: "Size and length concerns against bigger tight ends; needs to improve open-field tackling reliability.",
    projection: "Day 2–3 / Rounds 3–4",
    comp: "Jalen Pitre",
  },
};
