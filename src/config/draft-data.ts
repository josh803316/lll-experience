...
export const FIRST_ROUND_TEAMS_2026: Record<number, string> = {
  ...
  4: 'Tennessee Titans',
  5: 'New York Giants',
  6: 'Kansas City Chiefs', // traded up from CLE
...
/** Daniel Jeremiah 2026 Final Mock — https://www.nfl.com/news/daniel-jeremiah-final-2026-nfl-mock-draft — pick order 1–32. */
...
/** Peter Schrager 2026 Final Mock — https://www.espn.com/nfl/draft2026/story/_/id/48550650 — pick order 1–32. */
export const PETER_SCHRAGER_MOCK_2026: string[] = [
  'Fernando Mendoza',
  'David Bailey',
  'Jeremiyah Love',
  'Sonny Styles',
...
/** Bucky Brooks 2026 Mock Draft 4.0 — https://www.nfl.com/news/bucky-brooks-2026-nfl-mock-draft-4-0 — pick order 1–32. */
export const BUCKY_BROOKS_MOCK_2026: string[] = [
  'Fernando Mendoza',
  'David Bailey',
  'Arvell Reese',
  'Sonny Styles',
...
/** Lance Zierlein 2026 Mock Draft 4.0 — https://www.nfl.com/news/lance-zierlein-2026-nfl-mock-draft-4-0 — pick order 1–32. */
export const LANCE_ZIERLEIN_MOCK_2026: string[] = [
  'Fernando Mendoza',
  'David Bailey',
  'Jeremiyah Love',
  'Sonny Styles',
...
/** Chris Simms 2026 Final Mock — https://www.nbcsports.com/nfl/news/chris-simms-final-2026-nfl-mock-draft — pick order 1–32. */
export const CHRIS_SIMMS_MOCK_2026: string[] = [
  'Fernando Mendoza',
  'Arvell Reese',
  'Jeremiyah Love',
  'David Bailey',
...
/** Consensus 2026 draftable players (rank, name, school, position). Top 200 — updated April 2026. */
export const CONSENSUS_PLAYERS_2026: Array<{rank: number; playerName: string; school: string; position: string}> = [
  ...
  {rank: 11, playerName: 'Spencer Fano', school: 'Utah', position: 'OT'},
  {rank: 12, playerName: 'Makai Lemon', school: 'USC', position: 'WR'},
  {rank: 13, playerName: 'Jermod McCoy', school: 'Tennessee', position: 'CB'},
  ...
  {rank: 17, playerName: 'Monroe Freeling', school: 'Georgia', position: 'OT'},
  ...
  {rank: 23, playerName: 'Kadyn Proctor', school: 'Alabama', position: 'OT'},
  ...
  {rank: 28, playerName: 'KC Concepcion', school: 'Texas A&M', position: 'WR'},
  ...
  {rank: 32, playerName: 'C.J. Allen', school: 'Georgia', position: 'LB'},
  {rank: 33, playerName: 'Caleb Lomu', school: 'Utah', position: 'OT'},
  {rank: 34, playerName: 'Max Iheanachor', school: 'Arizona State', position: 'OT'},
  {rank: 35, playerName: 'Caleb Banks', school: 'Florida', position: 'DT'},
  ...
  {rank: 39, playerName: 'Anthony Hill Jr.', school: 'Texas', position: 'LB'},
  {rank: 40, playerName: 'Zion Young', school: 'Missouri', position: 'EDGE'},
  {rank: 41, playerName: 'Jadarian Price', school: 'Notre Dame', position: 'RB'},
  {rank: 42, playerName: 'Brandon Cisse', school: 'South Carolina', position: 'CB'},
  ...
  {rank: 46, playerName: 'Chase Bisontis', school: 'Texas A&M', position: 'IOL'},
  {rank: 47, playerName: 'Christen Miller', school: 'Georgia', position: 'DT'},
  {rank: 48, playerName: 'R Mason Thomas', school: 'Oklahoma', position: 'EDGE'},
  ...
  {rank: 169, playerName: 'Carson Beck', school: 'Georgia', position: 'QB'},
  {rank: 170, playerName: 'Drew Allar', school: 'Penn State', position: 'QB'},
  {rank: 171, playerName: "Ja'Kobi Lane", school: 'USC', position: 'WR'},
  {rank: 172, playerName: 'Skyler Gill-Howard', school: 'Texas Tech', position: 'DT'},
  {rank: 173, playerName: 'Isaiah World', school: 'Oregon', position: 'OT'},
  {rank: 174, playerName: 'Travis Burke', school: 'Memphis', position: 'OT'},
  {rank: 175, playerName: 'Marlin Klein', school: 'Michigan', position: 'TE'},
  {rank: 176, playerName: 'Deion Burks', school: 'Oklahoma', position: 'WR'},
  {rank: 177, playerName: 'Gracen Halton', school: 'Oklahoma', position: 'DT'},
  {rank: 178, playerName: 'Keyshaun Elliott', school: 'Arizona State', position: 'LB'},
  {rank: 179, playerName: 'Justin Joly', school: 'NC State', position: 'TE'},
  {rank: 180, playerName: 'DeMonte Capehart', school: 'Clemson', position: 'DT'},
  {rank: 181, playerName: 'Deontae Lawson', school: 'Alabama', position: 'LB'},
  {rank: 182, playerName: 'Bud Clark', school: 'TCU', position: 'S'},
  {rank: 183, playerName: 'Beau Stephens', school: 'Iowa', position: 'IOL'},
  {rank: 184, playerName: 'Bryce Boettcher', school: 'Oregon', position: 'LB'},
  {rank: 185, playerName: 'Mike Washington Jr.', school: 'Arkansas', position: 'RB'},
  {rank: 186, playerName: 'Barion Brown', school: 'LSU', position: 'WR'},
  {rank: 187, playerName: 'Seth McGowan', school: 'Kentucky', position: 'RB'},
  {rank: 188, playerName: 'Hezekiah Masses', school: 'California', position: 'CB'},
  {rank: 189, playerName: 'Bishop Fitzgerald', school: 'USC', position: 'S'},
  {rank: 190, playerName: 'Aaron Anderson', school: 'LSU', position: 'WR'},
  {rank: 191, playerName: 'Sam Roush', school: 'Stanford', position: 'TE'},
  {rank: 192, playerName: 'Robert Henry Jr.', school: 'UTSA', position: 'RB'},
  {rank: 193, playerName: 'Albert Regis', school: 'Texas A&M', position: 'DT'},
  {rank: 194, playerName: 'Dametrious Crownover', school: 'Texas A&M', position: 'IOL'},
  {rank: 195, playerName: "Dae'Quan Wright", school: 'Ole Miss', position: 'TE'},
  {rank: 196, playerName: 'VJ Payne', school: 'Kansas State', position: 'S'},
  {rank: 197, playerName: 'Tyren Montgomery', school: 'John Carroll', position: 'WR'},
  {rank: 198, playerName: 'Taurean York', school: 'Texas A&M', position: 'LB'},
  {rank: 199, playerName: 'Michael Taaffe', school: 'Texas', position: 'CB'},
  {rank: 200, playerName: 'Zavion Thomas', school: 'LSU', position: 'WR'},
  {rank: 201, playerName: 'Nicholas Singleton', school: 'Penn State', position: 'RB'},
];
...
export function getStaticPlayersBySource(
  ...
  const cbsRest = CONSENSUS_PLAYERS_2026.filter((p) => !top50Names.has(p.playerName)).map((p, i) => ({
    ...p,
    rank: 51 + i,
  }));
